...
class FileService implements FileServiceInterface
{
    ...
    {
        return Storage::disk(env('FILESYSTEM_DISK'))->putFile($path, $file);
    }
    ...
    {
        return Storage::disk(env('FILESYSTEM_DISK'))->delete($images);
    }
    ...
    {
        return Storage::disk(env('FILESYSTEM_DISK'))->exists($path);
    }
    ...
    {
        return Storage::disk(env('FILESYSTEM_DISK'))->put($path, $file);
    }
    ...
    {
        return Storage::disk(env('FILESYSTEM_DISK'))->copy($imageOld, $imageNew);
    }
    ...
    {
        return Storage::disk(env('FILESYSTEM_DISK'))->move($imageOld, $imageNew);
    }
